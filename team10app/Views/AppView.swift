...
struct AppView: View {
    ...
    var body: some View {
      ...
      TabView {
        ...
        ProfileView(user: User(firstName: "Dwight", lastName: "Schrute", email: "beetsbears@battlestargalatica.com", username: "assistantregionalmanager", profilePicURL: "", passwordHash: 123123))
        .tabItem {
